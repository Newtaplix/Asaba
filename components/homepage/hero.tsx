    ...
    <div>
        <div className='flex gap-2 mt-20 justify-center items-center p-2'>
            ...
            className="text-center md:text-left">
                ...
                className='primary rounded-full h-8 w-8 flex items-center justify-center text-white'><LucideWrench/></motion.div> Welcome to <span className="name">Asaba Auto Trading</span></h1>
